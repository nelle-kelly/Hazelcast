"""
Django settings for project_hazelcast project.
...
SECRET_KEY = 'django-insecure-xyu86d3du1(rt&avqz#^@#$l=dpborb56r%jbyl(kvf8d)io@s'
...
ROOT_URLCONF = 'project_hazelcast.urls'
...
WSGI_APPLICATION = 'project_hazelcast.wsgi.application'
...
#'myapp.hazelcast_cache.HazelcastCache' '127.0.0.1:5701'
